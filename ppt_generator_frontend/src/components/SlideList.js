...
export default function SlideList({
  ...
  /** Left rail list of slides with reorder/delete controls. Includes a pinned Global Cover at top. */
  ...
  return (
    <section className="card" aria-label="Slide list">
      <div className="cardHeader">
        ...
        <p className="cardHint">Global Cover is pinned as slide 1. Select a slide to edit and preview.</p>
      </div>
        ...
        <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "grid", gap: 10 }}>
          ...
          {slides.length === 0 ? (
            ...
            slides.map((slide, idx) => {
              ...
              const slideNumber = idx + 2; // +2 because #1 is global cover
              return (
                <li
                  key={slide.id}
                  style={{
